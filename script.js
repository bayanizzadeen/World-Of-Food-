  ...
  .then((data) => {
    ...
    data.meals.map((element) => {
      ...
      nameOfArea.addEventListener("click", () => {
        mealsFilterdArray = mealslist.filter(
          (x) => x.strArea == element.strArea
        );
...
const makeArts = (array) => {
  array.map((element) => {
    ...
    secPra.addEventListener("click", () => {
      //........................add meal in local for details
    ...
    heart.addEventListener("click", () => {
      //add eventlistener to heart icone
